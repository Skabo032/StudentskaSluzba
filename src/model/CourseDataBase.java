...
public class CourseDataBase {
	...
	private CourseDataBase() {
		...
		courses.add(new Course("p1"    ,"osnove programiranja"	    	    ,1,	7	,ProfessorDataBase.getInstance().getProfessor(1),Semester.WINTER));
		courses.add(new Course("p2"    ,"statistika"		        	    ,3,	8	,ProfessorDataBase.getInstance().getProfessor(1),Semester.SUMMER));
		courses.add(new Course("p3"    ,"algoritmi i strukture podataka"	,2,	9	,ProfessorDataBase.getInstance().getProfessor(1),Semester.SUMMER));
		courses.add(new Course("p4"    ,"LPRS"				                ,3,	7	,ProfessorDataBase.getInstance().getProfessor(1),Semester.WINTER));
		...
		courses.add(new Course("p8"    ,"osnove elektortehnike"		    	,1,	11	,ProfessorDataBase.getInstance().getProfessor(4),Semester.SUMMER));
		courses.add(new Course("p9"    ,"Sociologija"			            ,1,	10	,ProfessorDataBase.getInstance().getProfessor(4),Semester.WINTER));
		courses.add(new Course("p10"	,"Filozofija"		            	,1,	4	,ProfessorDataBase.getInstance().getProfessor(4),Semester.WINTER));
		courses.add(new Course("p11"	,"ORT"				                ,2,	7	,null	,Semester.SUMMER));
		courses.add(new Course("p12"	,"NANS"				                ,2,	5	,ProfessorDataBase.getInstance().getProfessor(5),Semester.SUMMER));
		courses.add(new Course("p13"	,"Organizacija podataka"		    ,2,	7	,ProfessorDataBase.getInstance().getProfessor(5),Semester.WINTER));
		courses.add(new Course("p14"	,"Baze podataka"			        ,2,	6	,ProfessorDataBase.getInstance().getProfessor(5),Semester.WINTER));
		courses.add(new Course("p15"	,"paralelno programiranje"		    ,2,	8	,ProfessorDataBase.getInstance().getProfessor(6),Semester.WINTER));
		courses.add(new Course("p16"	,"konkurentno programiranje"	    ,2,	9	,ProfessorDataBase.getInstance().getProfessor(6),Semester.SUMMER));
		...
		courses.add(new Course("it25"	,"Informaciona bezbednost"		    ,4,	9	,ProfessorDataBase.getInstance().getProfessor(16),Semester.SUMMER));
		courses.add(new Course("it26"	,"Elektronsko placanje"		        ,3,	8	,ProfessorDataBase.getInstance().getProfessor(17),Semester.WINTER));
		courses.add(new Course("it27"	,"Distribuirani sistemi"		    ,4,	6	,ProfessorDataBase.getInstance().getProfessor(18),Semester.SUMMER));
		courses.add(new Course("p28"	,"Projektovanje softvera"		    ,3,	5	,ProfessorDataBase.getInstance().getProfessor(17),Semester.WINTER));
		courses.add(new Course("p29"	,"Informacioni sistemi"		        ,4,	6	,ProfessorDataBase.getInstance().getProfessor(16),Semester.WINTER));
