...
public class ProfessorDataBase {
	...
	private ProfessorDataBase() {
		...
		professors.add(new Professor("321321321",	"Nikola"	,"Mirkovic",	LocalDate.parse("01.01.1978.",formatter)	,ak2,	"021/368-456",	"nikola.mirkovic@mailinator.com",	ap10,	22,	Title.REDOVNI_PROFESOR,new ArrayList<Course>()));
		...
		professors.add(new Professor("100100144",	"Vasa"	,"Micic",	LocalDate.parse("14.02.1970.",formatter)	,ak5,	"021/212-114",	"vasa.micic@mailinator.com",	ap10,	24,	Title.DOCENT,new ArrayList<Course>()));
		professors.add(new Professor("200020244",	"Srdjan"	,"Miletic",	LocalDate.parse("20.04.1966.",formatter)	,ak6,	"021/978-225",	"srdjan.miletic@mailinator.com",	ap10,	31,	Title.DOCENT,new ArrayList<Course>()));
		professors.add(new Professor("559585632",	"Branislav"	,"Mihajlovic",	LocalDate.parse("28.06.1980.",formatter)	,ak7,	"021/778-323",	"branislav.mihajlovic@mailinator.com",	ap10,	13,	Title.REDOVNI_PROFESOR	,new ArrayList<Course>()));
		...
		professors.add(new Professor("400400444",	"Branko"	,"Maricić",	LocalDate.parse("18.01.1973.",formatter)	,ak2,	"021/487-265",	"branko.maricic@mailinator.com",	ap10,	22,	Title.DOCENT	,new ArrayList<Course>()));
		professors.add(new Professor("500500544",	"Branislav"	,"Lukovic",	LocalDate.parse("08.04.1982.",formatter)	,ak3,	"021/159-478",	"branislav.lukovic@mailinator.com",	ap10,	9,	Title.REDOVNI_PROFESOR	,new ArrayList<Course>()));
		professors.add(new Professor("600600644",	"Branimir"	,"Obradović",	LocalDate.parse("07.01.1979.",formatter)	,ak1,	"021/922-333",	"branimir.obradovic@mailinator.com",	ap10,	17,	Title.DOCENT	,new ArrayList<Course>()));
